...
#SBATCH --exclusive
# Phase 3: Self-Forcing DMD distillation to Causal Model
...
# Use Phase 2 checkpoint as generator (student)
GENERATOR_MODEL_PATH="path"
REAL_SCORE_MODEL_PATH="path"  # Teacher model
FAKE_SCORE_MODEL_PATH="path"   # Critic model
