...
GENERATOR_MODEL_PATH="../WanGame-2.1"
REAL_SCORE_MODEL_PATH="../WanGame-2.1"  # Teacher model
FAKE_SCORE_MODEL_PATH="../WanGame-2.1-"  # Critic model

DATA_DIR="../FastvideoWorldModel-MC/preprocessed"
VALIDATION_DATASET_FILE="examples/distill/SFWanGame2.1/validation.json"

training_args=(
  --tracker_project_name wangame_distill_self_forcing_dmd
  --output_dir "checkpoints/wangame_distill_self_forcing_dmd"
  ...
  # --resume_from_checkpoint "checkpoints/wangame_distill_self_forcing_dmd/checkpoint-100"
)
...
miscellaneous_args=(
  ...
  --ema_decay 0.99
  --ema_start_step 100
  --init_weights_from_safetensors "checkpoints/wangame_ode_init_64gpu/checkpoint-2000/transformer"
)
