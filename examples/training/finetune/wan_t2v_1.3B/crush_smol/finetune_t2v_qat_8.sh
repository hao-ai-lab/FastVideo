#!/bin/bash
#SBATCH --job-name=wan_t2v_1.3B_finetune_qat_8
#SBATCH --partition=all
#SBATCH --nodes=2
#SBATCH --gres=gpu:4
#SBATCH --ntasks-per-node=1
#SBATCH --output=logs/wan_t2v_1.3B_finetune_qat_8.out
#SBATCH --error=logs/wan_t2v_1.3B_finetune_qat_8.err
...
training_args=(
  ...
  --output_dir "checkpoints/wan_t2v_finetune_qat_8"
