#!/bin/bash
#SBATCH --job-name=wan_t2v_1.3B_finetune_qat_8_NVL72
#SBATCH --nodes=4
#SBATCH --gres=gpu:4
#SBATCH --ntasks-per-node=1
#SBATCH --output=logs/wan_t2v_1.3B_finetune_qat_8_NVL72.out
#SBATCH --error=logs/wan_t2v_1.3B_finetune_qat_8_NVL72.err
