...
class DistributedAttention(nn.Module):
    ...
    def forward(
        ...
        # If Q is replicated (e.g. TP attention), fall back to local FlashAttention.
        use_ring_attention = (
        ...
        if use_ring_attention:
            ...
            ring_group_size = torch.distributed.get_world_size(ring_group)
            use_ring_attention = use_ring_attention and ring_group_size > 1
