...
from fastvideo.attention.yunchang.globals import (
    HAS_AITER,
    HAS_FLASH_ATTN,
    HAS_SAGE_ATTENTION,
...
def select_flash_attn_impl(impl_type: AttnType,
                           stage: str = "fwd-bwd",
    ...
    if impl_type == AttnType.AITER:
        ...
        if stage == "fwd-only":
            ...
            from fastvideo.attention.yunchang.ring.ring_pytorch_attn import ring_pytorch_attn_func
