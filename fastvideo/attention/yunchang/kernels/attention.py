...
from fastvideo.attention.yunchang.globals import HAS_FLASH_ATTN, HAS_FLASH_ATTN_HOPPER, HAS_FLASHINFER, HAS_AITER, HAS_NPU
...
def pytorch_attn_forward(
    ...
    assert op_type in ["flash", "efficient", "math",
                       "cudnn"], f"Invalid op_type: {op_type}"
    """
...
def flash_attn_backward(dout, q, k, v, out, softmax_lse, block_dq_buffer,
                        block_dk_buffer, block_dv_buffer, dropout_p,
                        softmax_scale, bwd_causal, window_size, softcap,
...
def flash_attn3_func_forward(q, k, v, dropout_p, softmax_scale, causal,
...
def flash_attn3_func_backward(dout, q, k, v, out, softmax_lse, block_dq_buffer,
                              block_dk_buffer, block_dv_buffer, dropout_p,
                              softmax_scale, bwd_causal, window_size, softcap,
                              alibi_slopes, deterministic, rng_state):
