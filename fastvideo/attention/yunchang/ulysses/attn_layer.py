...
from fastvideo.attention.yunchang.kernels import AttnType, select_flash_attn_impl
import torch.distributed as dist
from fastvideo.attention.yunchang.comm.all_to_all import SeqAllToAll4D
...
class UlyssesAttention(torch.nn.Module):
    ...
    def forward(self,
        ...
        output = SeqAllToAll4D.apply(self.spg, context_layer, self.gather_idx,
                                     self.scatter_idx, self.use_sync)
