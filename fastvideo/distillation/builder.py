...
def build_runtime_from_config(cfg: DistillRunConfig) -> DistillRuntime:
    """Build a distillation runtime from a Phase 2 YAML config.
    ...
    family_builder = get_family(str(cfg.distill.model))
...
def build_wan_dmd2_runtime_from_config(cfg: DistillRunConfig) -> DistillRuntime:
    ...
    if cfg.distill.model != "wan" or cfg.distill.method != "dmd2":
        raise ValueError(
