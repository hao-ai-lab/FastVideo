...
SYSTEM_PROMPT = (
    "You are a strict comparative evaluator of third-person video-game "
...
RESPONSE_SCHEMA = {
    "type": "object",
    "properties": {
        "video_1_analysis": {"type": "string"},
        "video_2_analysis": {"type": "string"},
        "comparison": {"type": "string"},
        "winner": {"type": "string", "enum": ["video_1", "video_2", "tie"]},
    },
...
def _resolve_api_key() -> str:
    ...
    raise ValueError(
        "judge.third_person_separation needs a Gemini API key. Set "
...
class ThirdPersonSeparationMetric(BaseMetric):
    ...
    def _one_call(self, image: str | None, vid1: str, vid2: str, action_text: str) -> str:
        ...
        if image is not None:
            contents += ["\nFirst frame (input condition, shared by BOTH videos):", self._upload(image)]
        contents += [
