...
class FinalLayer(nn.Module):
    ...
    def forward(self, x, c):
        ...
        # (Worker pid=266150) c.shape: torch.Size([1, 2048])
# (Worker pid=266150) scale.shape: torch.Size([1, 2048])
# (Worker pid=266150) scale.unsqueeze(1).shape: torch.Size([1, 1, 2048])
# (Worker pid=266150) shift.shape: torch.Size([1, 2048])
# (Worker pid=266150) shift.unsqueeze(1).shape: torch.Size([1, 1, 2048])
# (Worker pid=266150) x.shape: torch.Size([1, 24960, 2048])
# (Worker pid=266150) self.norm_final(x).shape: torch.Size([1, 24960, 2048])
