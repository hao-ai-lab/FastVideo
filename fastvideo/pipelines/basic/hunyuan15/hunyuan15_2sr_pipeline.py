...
class HunyuanVideo152SRPipeline(ComposedPipelineBase):
    ...
    def create_pipeline_stages(self, fastvideo_args: FastVideoArgs):
        ...
        self.add_stage(
            stage_name="sr_720p_latent_preparation_stage",
            stage=LatentPreparationStage(
        ...
        self.add_stage(
            stage_name="sr_720p_denoising_stage",
        ...
        self.add_stage(
            stage_name="sr_1080p_latent_preparation_stage",
            stage=LatentPreparationStage(
                scheduler=self.get_module("scheduler"), transformer=self.get_module("transformer_3")
            ),
        )

        self.add_stage(
            stage_name="sr_1080p_denoising_stage",
            stage=SRDenoisingStage(
