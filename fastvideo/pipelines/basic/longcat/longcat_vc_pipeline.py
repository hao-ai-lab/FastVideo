...
class LongCatVideoContinuationPipeline(LoRAPipeline, ComposedPipelineBase):
    ...
    def create_pipeline_stages(self, fastvideo_args: FastVideoArgs):
        ...
        self.add_stage(
            stage_name="video_vae_encoding_stage", stage=LongCatVideoVAEEncodingStage(vae=self.get_module("vae"))
        )
        ...
        self.add_stage(
            stage_name="kv_cache_init_stage", stage=LongCatKVCacheInitStage(transformer=self.get_module("transformer"))
        )
