...
MAGI_HUMAN_BASE = InferencePreset(
    ...
    description=(
        "daVinci-MagiHuman base text-to-AV at 256x480, 4s @ 25 fps. "
...
MAGI_HUMAN_DISTILL = InferencePreset(
    ...
    model_family="magi_human",
    description=(
        "daVinci-MagiHuman DMD-2 distilled text-to-AV at 256x480, 4s @ "
...
MAGI_HUMAN_BASE_TI2V = InferencePreset(
    ...
    model_family="magi_human",
    description=(
        "daVinci-MagiHuman base text+image-to-AV at 256x480, 4s @ 25 fps. "
...
MAGI_HUMAN_DISTILL_TI2V = InferencePreset(
    ...
    model_family="magi_human",
    description=(
        "daVinci-MagiHuman DMD-2 distilled text+image-to-AV at 256x480, 4s @ 25 fps. 8-step inference, no CFG."
    ),
    workload_type="i2v",
    stage_schemas=(_DENOISE_STAGE,),
    defaults={
...
MAGI_HUMAN_SR_540P = InferencePreset(
    ...
    model_family="magi_human",
    description=(
        "daVinci-MagiHuman two-stage base + SR-540p text-to-AV. "
...
MAGI_HUMAN_SR_540P_TI2V = InferencePreset(
    ...
    model_family="magi_human",
    description=(
        "daVinci-MagiHuman two-stage base + SR-540p text+image-to-AV. "
...
MAGI_HUMAN_SR_1080P = InferencePreset(
    ...
    model_family="magi_human",
    description=(
        "daVinci-MagiHuman two-stage base + SR-1080p text-to-AV. "
...
MAGI_HUMAN_SR_1080P_TI2V = InferencePreset(
    ...
    model_family="magi_human",
    description=(
        "daVinci-MagiHuman two-stage base + SR-1080p text+image-to-AV. "
        "The SR DiT uses upstream local-window attention in 32 of "
