...
class HunyuanVideoPipeline(ComposedPipelineBase):
    ...
    def setup_pipeline(self, inference_args: InferenceArgs):
        ...
        self.add_stage("prompt_encoding_stage_primary", PromptEncodingStage(is_secondary=False))
        self.add_stage("prompt_encoding_stage_secondary", PromptEncodingStage(is_secondary=True))
