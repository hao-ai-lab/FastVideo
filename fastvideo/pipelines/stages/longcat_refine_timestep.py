...
class LongCatRefineTimestepStage(PipelineStage):
    ...
    def forward(
        ...
        self.scheduler.set_timesteps(num_inference_steps, sigmas=base_sigmas, device=device)
        ...
        logger.info("Refinement timesteps: %s steps starting from t=%s", len(timesteps), t_thresh)
