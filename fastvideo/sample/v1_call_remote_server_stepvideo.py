    ...
    def get(self):
        with lock:
            try:
                ...
                # import traceback
                #  traceback.print_exc()                        # <-- full stack trace on server stdout
                #  return Response(
                #      traceback.format_exc(),
                #      status=500,
                #      mimetype="text/plain"                     # <-- return the traceback so you can see it client‑side
                #  )
