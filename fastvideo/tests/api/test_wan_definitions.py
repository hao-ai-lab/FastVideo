...
LEGACY_VARIANTS = (
    ...
    ("FastVideo/FastWan2.2-TI2V-5B-FullAttn-Diffusers", "FastWan2_2_TI2V_5B_FullAttn_Config", "fast_wan_2_2_ti2v_5b", ("t2v",)),
    ("FastVideo/FastWan2.2-TI2V-5B-Diffusers", "FastWan2_2_TI2V_5B_FullAttn_Config", "fast_wan_2_2_ti2v_5b", ("t2v",)),
...
@pytest.mark.parametrize("config_name,flow_shift,dmd_steps,load_encoder", [
    ...
    ("FastWan2_2_TI2V_5B_FullAttn_Config", 5.0, [1000, 757, 522], False),
