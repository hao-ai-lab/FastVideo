...
def run_test(pytest_command: str):
    ...
    cd /FastVideo &&
    {checkout_command} &&
    uv pip install -e csrc/fastvideo_kernel &&
...
def run_precision_tests_STA():
    run_test("pytest csrc/fastvideo_kernel/tests/test_correctness.py")
...
def run_precision_tests_vmoba():
    run_test("pytest csrc/fastvideo_kernel/tests/test_vmoba_correctness.py")
