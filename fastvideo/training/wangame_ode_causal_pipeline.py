...
class WanGameODEInitTrainingPipeline(TrainingPipeline):
    """
    ...
    def _step_predict_next_latent(
        ...
        if keyboard_cond is not None and mouse_cond is not None:
            ...
            viewmats = torch.stack(viewmats_list, dim=0).to(device=device,
        ...
        empty_text = torch.zeros((latent_model_input.shape[0], 0,
...
def main(args) -> None:
    ...
    pipeline = WanGameODEInitTrainingPipeline.from_pretrained(
