...
class HunyuanVideoArchConfig(DiTArchConfig):
    ...
    _supported_attention_backends: Tuple[_Backend, ...] = field(default_factory=lambda: (_Backend.SLIDING_TILE_ATTN,
                                     _Backend.FLASH_ATTN, _Backend.TORCH_SDPA))
    
    _param_names_mapping: dict = field(default_factory=lambda: {
