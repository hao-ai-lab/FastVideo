...
from fastvideo.v1.pipelines.preprocess_pipeline_base import BasePreprocessPipeline
...
class PreprocessPipeline_I2V(BasePreprocessPipeline):
    ...
    def get_extra_features(self, valid_data: Dict[str, Any], fastvideo_args: FastVideoArgs) -> Dict[str, Any]:
        ...
        # Get CLIP features
        pixel_values = torch.cat([img['pixel_values'] for img in processed_images], dim=0).to(fastvideo_args.device)
        with torch.no_grad():
