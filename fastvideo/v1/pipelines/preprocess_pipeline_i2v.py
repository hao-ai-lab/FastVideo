...
from fastvideo.v1.dataset.dataloader.schema import (pyarrow_schema_i2v as
                                                    pyarrow_schema)
    ...
    def preprocess_video_and_text(self, fastvideo_args: FastVideoArgs, args):
        ...
        for batch_idx, data in enumerate(pbar):
            ...
            for idx, video_path in save_pbar:
                ...
                clip_feature = clip_features[idx].cpu().numpy()
            ...
            if batch_data:
                ...
                arrays = [
                    ...
                    pa.array(
                        [record["clip_feature_bytes"] for record in batch_data],
                        type=pa.binary()),
                    pa.array(
