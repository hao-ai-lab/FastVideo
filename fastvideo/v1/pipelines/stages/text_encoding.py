    ...
    def forward(
        ...
        for tokenizer, text_encoder, encoder_config, preprocess_func, postprocess_func in zip(
            ...
            if fastvideo_args.use_cpu_offload:
                text_encoder = text_encoder.to(get_local_device())
            ...
            text_inputs = tokenizer(
                texts, **encoder_config.tokenizer_kwargs).to(get_local_device())
            ...
            if batch.do_classifier_free_guidance:
                ...
                negative_text_inputs = tokenizer(
                    negative_text,
                    **encoder_config.tokenizer_kwargs).to(get_local_device())
