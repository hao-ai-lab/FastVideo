from fastvideo.models.vaes import AutoencoderKLHunyuanVideo as MyHunyuanVAE 
...
def test_hunyuan_vae():
    ...
    with torch.no_grad():
        ...
        assert max_diff_decode < 1e-3, f"Decoded outputs differ significantly: max diff = {max_diff_decode.item()}"
