...
def test_wan_distributed():
    ...
    with open("/workspace/data/Wan2.1-T2V-1.3B-Diffusers/transformer/config.json", "r") as f:
        config = json.load(f)
    ...
    weight_dir_list = glob.glob("/workspace/data/Wan2.1-T2V-1.3B-Diffusers/transformer/*.safetensors")
    # to str
    ...
    with open("/workspace/data/Wan2.1-T2V-1.3B/config.json", "r") as f:
    ...
    state_dict = load_file("/workspace/data/Wan2.1-T2V-1.3B/diffusion_pytorch_model.safetensors")
