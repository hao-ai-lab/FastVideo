...
reference_wandb_summary_file = "fastvideo/v1/tests/training/reference_wandb_summary_VSA.json"
...
def test_distributed_training():
    ...
    summary_file = "fastvideo/v1/tests/training/reference_wandb_summary_VSA.json"
