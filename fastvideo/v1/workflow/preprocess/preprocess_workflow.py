...
class PreprocessWorkflow(WorkflowBase):
    ...
    def register_components(self) -> None:
        ...
        # training dataset
        training_dataset = load_dataset(preprocess_config.dataset_path, split="train")
        training_dataset = training_dataset.filter(self.raw_data_validator)
        ...
        # validation dataset
        validation_dataset = load_dataset(preprocess_config.dataset_path, split="validation")
        validation_dataset = validation_dataset.filter(self.raw_data_validator)
