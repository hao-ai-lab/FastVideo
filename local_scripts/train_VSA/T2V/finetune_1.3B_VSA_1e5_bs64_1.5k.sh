...
#SBATCH --mem=1440G
#SBATCH --output=vsa-t2v/1.3B-1e5-1.5k.out
#SBATCH --error=vsa-t2v/1.3B-1e5-1.5k.err
#SBATCH --exclusive
set -e -x
...
OUTPUT_PATH="/mnt/sharefs/users/hao.zhang/Vchitect-2M/Wan-Syn_77x768x1280/VSA_T2V_1.3B_1e5_bs64_1.5k"
