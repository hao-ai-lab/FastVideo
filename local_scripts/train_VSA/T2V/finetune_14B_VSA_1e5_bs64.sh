...
#SBATCH --mem=1440G
#SBATCH --output=vsa-t2v/1e5.out
#SBATCH --error=vsa-t2v/1e5.err
#SBATCH --exclusive
set -e -x
...
OUTPUT_PATH="/mnt/sharefs/users/hao.zhang/Vchitect-2M/Wan-Syn_77x768x1280/VSA_T2V_14B_1e5_bs64"
...
srun torchrun --nnodes 16 --nproc_per_node $NUM_GPUS \
