...
#SBATCH --mem=1440G
#SBATCH --output=vsa-t2v/8e6.out
#SBATCH --error=vsa-t2v/8e6.err
#SBATCH --exclusive
set -e -x
...
OUTPUT_PATH="/mnt/sharefs/users/hao.zhang/Vchitect-2M/Wan-Syn_77x768x1280/VSA_T2V_14B_8e6_bs64"
