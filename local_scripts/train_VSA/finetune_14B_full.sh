...
#SBATCH --mem=1440G
#SBATCH --output=vsa-t2v/full.out
#SBATCH --error=vsa-t2v/full.err
#SBATCH --exclusive
set -e -x
...
OUTPUT_PATH="/mnt/sharefs/users/hao.zhang/Vchitect-2M/Wan-Syn_77x768x1280/VSA_T2V_14B_full"
...
srun torchrun --nnodes 4 --nproc_per_node $NUM_GPUS \
    ...
    --model_path ../data/Wan2.1-T2V-14B-Diffusers \
    --inference_mode False\
    --pretrained_model_name_or_path ../data/Wan2.1-T2V-14B-Diffusers \
