...
torchrun --nnodes 2 --nproc_per_node 8\
    ...
    --cfg 0.0\
    --log_validation\
    --output_dir="$DATA_DIR/outputs/base40_cfg0.0"\
    --tracker_project_name PCM \
    --num_frames  163 \
    --scheduler_type pcm_linear_quadratic \
    --validation_guidance_scale "1.5,2.5,4.5" \
...
torchrun --nnodes 2 --nproc_per_node 8\
    ...
    --cfg 0.0\
    --log_validation\
    --output_dir="$DATA_DIR/outputs/base40_cfg2.5"\
    --tracker_project_name PCM \
    --num_frames  163 \
    --scheduler_type pcm_linear_quadratic \
    --validation_guidance_scale "1.5,2.0,2.5,3.5" \
    --num_euler_timesteps 50 \
    --linear_quadratic_threshold 0.1 \
    --linear_range 0.75 \
    --multi_phased_distill_schedule "700-1" \
...
torchrun --nnodes 2 --nproc_per_node 8\
    ...
    --cfg 0.0\
    --log_validation\
    --output_dir="$DATA_DIR/outputs/lq_euler_50_thres0.1_lrg_phase1_lr1e-6_l2_reconstruct_decay_0.07"\
    --tracker_project_name PCM \
    --num_frames  163 \
    --scheduler_type pcm_linear_quadratic \
