...
VALIDATION_TEXT_ENCODER_CPU_FORWARD="${VALIDATION_TEXT_ENCODER_CPU_FORWARD:-true}"
...
cmd=(
    ...
    --callbacks.validation.text_encoder_cpu_forward "$VALIDATION_TEXT_ENCODER_CPU_FORWARD"
...
echo "  validation text encoder CPU forward: $VALIDATION_TEXT_ENCODER_CPU_FORWARD"
