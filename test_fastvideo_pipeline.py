...
def generate_video() -> bool:
    ...
    # Configuration
    #input_image_path = "/mnt/fast-disks/hao_lab/kevin/FastVideo/tennis.jpg"
    ...
    input_image_path = "/mnt/fast-disks/hao_lab/kevin/FastVideo/yellow-scrubber.png"
    ...
    output_path = "/mnt/fast-disks/hao_lab/kevin/FastVideo/cosmos2_fastvideo_output.mp4"
    ...
    try:
        ...
        result = generator.generate_video(height=704,
                                          width=1280,
                                          prompt=prompt,
