...
The pinned ``cosmos-framework`` modality defaults use shift 10.0 for T2V/I2V
and shift 3.0 for T2I. ``_set_flow_shift`` rebuilds the FastVideo scheduler
when a request changes modes.
...
def test_video_engine_init_flow_shift_is_10() -> None:
    """T2V/I2V start from the official video shift of 10.0."""
    try:
        from fastvideo.pipelines.basic.cosmos3.cosmos3_pipeline import (  # type: ignore
            Cosmos3OmniDiffusersPipeline,
        )
