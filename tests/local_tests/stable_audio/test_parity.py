...
Requires: official_weights/stable-audio-open-1.0/ with model.safetensors and model_config.json
"""
import argparse
import os
import sys
...
def _checkpoint_exists():
    if not os.path.exists(CHECKPOINT_PATH):
        print(f"SKIP: {CHECKPOINT_PATH} not found. Download model first.")
        return False
    return True
