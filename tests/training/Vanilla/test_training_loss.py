...
a40_reference_wandb_summary_file = str(_REFERENCE_DIR / "a40_reference_wandb_summary.json")
l40s_reference_wandb_summary_file = str(_REFERENCE_DIR / "l40s_reference_wandb_summary.json")
