...
import { useActiveTab, type ActiveTab } from "@/contexts/ActiveTabContext";
...
export default function Home() {
	...
	return (
		<div className={primarySidebarStyles.layout}>
			...
			>
				{activeTab === "inference" && (
					<JobQueuePage jobType="inference" />
				)}
				{activeTab === "finetuning" && (
					<JobQueuePage jobType="finetuning" />
				)}
				{activeTab === "distillation" && (
					<JobQueuePage jobType="distillation" />
				)}
