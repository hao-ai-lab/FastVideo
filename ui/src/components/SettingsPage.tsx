...
export default function SettingsPage() {
	...
	const DefaultModelSelect = ({
		...
		<div className={formStyles.formRow}>
			<label htmlFor={`settings-default-model-${workloadType}`}>
				{label}
			</label>
			<select
		...
		<main className={layoutStyles.main}>
			<section className={cardStyles.card}>
				...
				>
					...
					Adjust them below to match your typical workflow.
				</p>
				<div className={formStyles.settingsGrid}>
					...
					<div className={formStyles.formRow}>
						<label htmlFor="settings-num-steps">
							Inference Steps
						</label>
						<Slider
							...
							onChange={(v) =>
								updateOption("numInferenceSteps", v)
							}
						/>
					</div>
					<div className={formStyles.formRow}>
					...
					<div className={formStyles.formRow}>
						<label htmlFor="settings-guidance">
							Guidance Scale
						</label>
						<Slider
					...
					<div className={formStyles.formRow}>
						<label htmlFor="settings-dit-cpu-offload">
							DiT CPU Offload
						</label>
						<Toggle
					...
					<div className={formStyles.formRow}>
						...
						<Toggle
							...
							onChange={(v) =>
								updateOption("textEncoderCpuOffload", v)
							}
						/>
					</div>
					<div className={formStyles.formRow}>
						...
						<Toggle
							...
							onChange={(v) =>
								updateOption("useFsdpInference", v)
							}
						/>
					</div>
					<div className={formStyles.formRow}>
						<label htmlFor="settings-vae-cpu-offload">
							VAE CPU Offload
						</label>
						<Toggle
					...
					<div className={formStyles.formRow}>
						...
						<Toggle
							...
							onChange={(v) =>
								updateOption("imageEncoderCpuOffload", v)
							}
						/>
					</div>
					<div className={formStyles.formRow}>
						...
						<Toggle
							...
							onChange={(v) =>
								updateOption("enableTorchCompile", v)
							}
						/>
					</div>
					<div className={formStyles.formRow}>
