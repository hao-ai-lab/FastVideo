...
export const WORKLOAD_OPTIONS: Record<JobType, WorkloadOption[]> = {
  ...
  finetuning: [
    { type: "full_t2v", label: "Full T2V", desc: "Full finetune Text to Video" },
    { type: "full_i2v", label: "Full I2V", desc: "Full finetune Image to Video" },
    { type: "vsa_t2v", label: "VSA T2V", desc: "VSA finetune Text to Video" },
    { type: "vsa_i2v", label: "VSA I2V", desc: "VSA finetune Image to Video" },
    { type: "ode_init", label: "ODE Init", desc: "ODE-init consistency finetune" },
    {
      type: "matrixgame_i2v",
      label: "MatrixGame I2V",
      desc: "MatrixGame 2.0 I2V finetune",
    },
    { type: "ltx2_t2v", label: "LTX2 T2V", desc: "LTX-2 Text to Video finetune" },
  ],
  distillation: [
    { type: "dmd_t2v", label: "DMD T2V", desc: "DMD distillation Text to Video" },
    { type: "dmd_i2v", label: "DMD I2V", desc: "DMD distillation Image to Video" },
    {
