...
from v2._vendor.configs.models import (DiTConfig, EncoderConfig, ModelConfig, VAEConfig, UpsamplerConfig)
...
from v2._vendor.utils import FlexibleArgumentParser, StoreBoolean, shallow_asdict
...
class PipelineConfig:
    ...
    def from_pretrained(cls, model_path: str) -> "PipelineConfig":
        ...
        """
        from v2._vendor.configs.pipeline_registry import get_pipeline_config_cls_from_name
