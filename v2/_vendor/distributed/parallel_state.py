...
from v2._vendor.distributed.device_communicators.base_device_communicator import (DeviceCommunicatorBase)
from v2._vendor.distributed.device_communicators.cpu_communicator import (CpuCommunicator)
    ...
    def __init__(
        ...
        if use_device_communicator and self.world_size > 1:
            ...
            if current_platform.is_cuda_alike():
                from v2._vendor.distributed.device_communicators.cuda_communicator import (CudaCommunicator)
                ...
                from v2._vendor.distributed.device_communicators.npu_communicator import (NpuCommunicator)
