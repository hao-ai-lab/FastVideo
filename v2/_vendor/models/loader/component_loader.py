...
from v2._vendor.configs.models import EncoderConfig
from v2._vendor.distributed import get_local_torch_device
...
from v2._vendor.models.encoders.base import TextEncoder
from v2._vendor.models.hf_transformer_utils import get_diffusers_config
from v2._vendor.models.loader.fsdp_load import maybe_load_fsdp_model, shard_model
from v2._vendor.models.loader.utils import set_default_torch_dtype
from v2._vendor.models.loader.weight_utils import (
    filter_duplicate_safetensors_files,
    filter_files_not_needed_for_inference,
    pt_weights_iterator,
    safetensors_weights_iterator,
)
from v2._vendor.models.registry import ModelRegistry
from v2._vendor.utils import PRECISION_TO_TYPE, is_pin_memory_available
from v2._vendor.hooks.layerwise_offload import enable_layerwise_offload
    ...
    def load(self, model_path: str, fastvideo_args: FastVideoArgs):
        ...
        with set_default_torch_dtype(
            ...
            if is_gen3c and class_name in (
                ...
                from v2._vendor.models.vaes.gen3c_tokenizer_vae import (
            ...
            if class_name == "AutoencoderKLWan" and is_cosmos25:
                from v2._vendor.models.vaes.cosmos25wanvae import Cosmos25WanVAE
...
class TransformerLoader(ComponentLoader):
    ...
    def load(self, model_path: str, fastvideo_args: FastVideoArgs):
        ...
        if _qat_generator_only:
            ...
            from v2._vendor.attention.selector import _cached_get_attn_backend
...
class ConditionerLoader(ComponentLoader):
    ...
    def load(self, model_path: str, fastvideo_args: FastVideoArgs):
        ...
        from v2._vendor.configs.models.encoders import (
