...
_SUBPROCESS_COMMAND = [sys.executable, "-m", "v2._vendor.models.dits.registry"]
...
ModelRegistry = _ModelRegistry({
    ...
    _LazyRegisteredModel(
        module_name=(f"v2._vendor.models.{component_name}.{mod_relname}"
                     if mod_relname else f"v2._vendor.models.{component_name}"),
