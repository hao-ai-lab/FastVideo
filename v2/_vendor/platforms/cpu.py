...
from v2._vendor.platforms.interface import CpuArchEnum, Platform, PlatformEnum
...
class CpuPlatform(Platform):
    ...
    def get_device_communicator_cls(cls) -> str:
        return "v2._vendor.distributed.device_communicators.cpu_communicator.CpuCommunicator"
