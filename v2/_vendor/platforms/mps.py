...
from v2._vendor.platforms.interface import (DeviceCapability, Platform, PlatformEnum)
...
class MpsPlatform(Platform):
    ...
    def get_device_communicator_cls(cls) -> str:
        ...
        return "v2._vendor.distributed.device_communicators.base_device_communicator.DeviceCommunicatorBase"
