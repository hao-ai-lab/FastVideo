...
from v2._vendor.platforms.interface import (AttentionBackendEnum, Platform, PlatformEnum)
...
class NPUPlatform(Platform):
    ...
    def get_device_communicator_cls(cls) -> str:
        return "v2._vendor.distributed.device_communicators.npu_communicator.NpuCommunicator"
