...
from v2.configs.models import (DiTConfig, EncoderConfig, ModelConfig, VAEConfig, UpsamplerConfig)
from v2.configs.models.encoders import BaseEncoderOutput
from v2.configs.utils import update_config_from_args
from v2.logger import init_logger
from v2.utils import FlexibleArgumentParser, StoreBoolean, shallow_asdict
...
class PipelineConfig:
    ...
    def from_pretrained(cls, model_path: str) -> "PipelineConfig":
        ...
        """
        from v2.configs.pipeline_registry import get_pipeline_config_cls_from_name
