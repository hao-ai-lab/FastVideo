...
from v2.configs.models import EncoderConfig
from v2.distributed import get_local_torch_device
from v2.fastvideo_args import FastVideoArgs
from v2.layers.quantization import get_quantization_config
from v2.logger import init_logger
from v2.models.encoders.base import TextEncoder
from v2.models.hf_transformer_utils import get_diffusers_config
from v2.models.loader.fsdp_load import maybe_load_fsdp_model, shard_model
from v2.models.loader.utils import set_default_torch_dtype
from v2.models.loader.weight_utils import (
    filter_duplicate_safetensors_files,
    filter_files_not_needed_for_inference,
    pt_weights_iterator,
    safetensors_weights_iterator,
)
from v2.models.registry import ModelRegistry
from v2.utils import PRECISION_TO_TYPE, is_pin_memory_available
from v2.hooks.layerwise_offload import enable_layerwise_offload
...
class ComponentLoader(ABC):
    ...
    def for_module_type(
        ...
        if module_type in module_loaders:
            ...
            # Allow v2.* libraries for custom implementations (e.g. Cosmos2_5Pipeline)
            # that aren't available in diffusers/transformers yet
            is_fastvideo_module = transformers_or_diffusers.startswith("v2.")
    ...
    def load(self, model_path: str, fastvideo_args: FastVideoArgs):
        ...
        with set_default_torch_dtype(
            ...
            if is_gen3c and class_name in (
                ...
                from v2.models.vaes.gen3c_tokenizer_vae import (
            ...
            if class_name == "AutoencoderKLWan" and is_cosmos25:
                from v2.models.vaes.cosmos25wanvae import Cosmos25WanVAE
...
class TransformerLoader(ComponentLoader):
    ...
    def load(self, model_path: str, fastvideo_args: FastVideoArgs):
        ...
        if _qat_generator_only:
            ...
            from v2.attention.selector import _cached_get_attn_backend
...
class ConditionerLoader(ComponentLoader):
    ...
    def load(self, model_path: str, fastvideo_args: FastVideoArgs):
        ...
        from v2.configs.models.encoders import (
