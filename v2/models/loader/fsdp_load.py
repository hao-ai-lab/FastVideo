...
from v2.models.loader.utils import (get_param_names_mapping,
                                           hf_to_custom_state_dict)
from v2.models.loader.weight_utils import safetensors_weights_iterator
from v2.utils import set_mixed_precision_policy, is_pin_memory_available
...
def _maybe_convert_model_to_nvfp4(model: nn.Module) -> None:
    ...
    # NVFP4 is wired.
    from v2.layers.quantization.nvfp4_config import (
        NVFP4QuantizeMethod, convert_model_to_nvfp4,
    )
    from v2.layers.quantization.nvfp4_qat_config import (
