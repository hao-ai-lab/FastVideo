...
_SUBPROCESS_COMMAND = [sys.executable, "-m", "v2.models.dits.registry"]
...
ModelRegistry = _ModelRegistry({
    ...
    _LazyRegisteredModel(
        module_name=(f"v2.models.{component_name}.{mod_relname}"
                     if mod_relname else f"v2.models.{component_name}"),
