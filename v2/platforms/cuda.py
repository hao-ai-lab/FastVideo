...
import v2.envs as envs
from v2.logger import init_logger
from v2.platforms.interface import (AttentionBackendEnum, DeviceCapability, Platform, PlatformEnum)
from v2.utils import import_pynvml
    ...
    def get_attn_backend_cls(cls, selected_backend: AttentionBackendEnum | None, head_size: int,
        ...
        if selected_backend == AttentionBackendEnum.SAGE_ATTN:
            try:
                ...
                from v2.attention.backends.sage_attn import (  # noqa: F401
                    SageAttentionBackend)
                logger.info("Using Sage Attention backend.")

                return "v2.attention.backends.sage_attn.SageAttentionBackend"
            ...
            try:
                ...
                from v2.attention.backends.sage_attn3 import (  # noqa: F401
                    SageAttention3Backend)
                logger.info("Using Sage Attention 3 backend.")

                return "v2.attention.backends.sage_attn3.SageAttention3Backend"
            except ImportError as e:
                logger.info(e)
            ...
            from v2.attention.backends.attn_qat_infer import (  # noqa: F401
            ...
            if is_attn_qat_infer_available():
                ...
                return "v2.attention.backends.attn_qat_infer.AttnQatInferBackend"
            ...
            from v2.attention.backends.attn_qat_train import (  # noqa: F401
            ...
            if is_attn_qat_train_available():
                ...
                return "v2.attention.backends.attn_qat_train.AttnQatTrainBackend"
            raise ImportError(
            ...
            try:
                ...
                from v2.attention.backends.video_sparse_attn import (  # noqa: F401
                    VideoSparseAttentionBackend)
                logger.info("Using Video Sparse Attention backend.")

                return "v2.attention.backends.video_sparse_attn.VideoSparseAttentionBackend"
            except ImportError as e:
            ...
            try:
                from v2.attention.backends.bsa_attn import (  # noqa: F401
                    BSAAttentionBackend)
                logger.info("Using BSA Attention backend.")

                return "v2.attention.backends.bsa_attn.BSAAttentionBackend"
            except ImportError as e:
            ...
            try:
                ...
                from v2.attention.backends.vmoba import (  # noqa: F401
                    VMOBAAttentionBackend)
                logger.info("Using Video MOBA Attention backend.")

                return "v2.attention.backends.vmoba.VMOBAAttentionBackend"
            except ImportError as e:
            ...
            try:
                from v2.attention.backends.sla import (  # noqa: F401
                    SLAAttentionBackend)
                logger.info("Using SLA (Sparse-Linear Attention) backend.")

                return "v2.attention.backends.sla.SLAAttentionBackend"
            except ImportError as e:
            ...
            try:
                ...
                return "v2.attention.backends.sla.SageSLAAttentionBackend"
            except ImportError as e:
            ...
            return "v2.attention.backends.sdpa.SDPABackend"
        ...
        if target_backend == AttentionBackendEnum.FLASH_ATTN:
            try:
                ...
                from v2.attention.backends.flash_attn import (  # noqa: F401
        ...
        return "v2.attention.backends.flash_attn.FlashAttentionBackend"

    @classmethod
    def get_device_communicator_cls(cls) -> str:
        return "v2.distributed.device_communicators.cuda_communicator.CudaCommunicator"  # noqa
