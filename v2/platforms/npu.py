...
from v2.platforms.interface import (AttentionBackendEnum, Platform, PlatformEnum)
...
class NPUPlatform(Platform):
    ...
    def get_device_communicator_cls(cls) -> str:
        return "v2.distributed.device_communicators.npu_communicator.NpuCommunicator"
