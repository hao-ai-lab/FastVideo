"""Wan2.1-1.3B ModelCard — the (recipe, runtime) pair for T2V.
...
def build_wan22_ti2v_card(model_id: str = "wan2.2-ti2v-5b", *, checkpoint_root: str | None = None) -> ModelCard:
    ...
    return build_wan21_card(model_id=model_id,
                            flow_shift=5.0,
...
def build_wan22_a14b_card(model_id: str = "wan2.2-t2v-a14b",
                          *,
                          checkpoint_root: str | None = None,
    ...
    components = {
        ...
        ComponentSpec(component_id="vae",
                      ...
                      required_for={"t2v"}),
        "transformer":
        _dit_spec("transformer"),
        "transformer_2":
        _dit_spec("transformer_2"),
    }
    loops = {
        "diffusion_denoise":
        LoopSpec(loop_id="diffusion_denoise",
