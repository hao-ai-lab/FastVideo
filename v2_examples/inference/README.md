...
[`../../designv4.md`](../../designv4.md)). On a GPU box you swap `ComponentSpec.factory` for the torch
...
All five use only the public API (`v2.models.build_default_engine`, `v2.request.make_request`,
